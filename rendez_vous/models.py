...
class Heure(models.Model):
    heure = models.CharField(primary_key=True, max_length=20)
...
class Rdv(models.Model):
    ...
    status = models.CharField(max_length=10, choices = choix_status, default='Absent')
    ...
    heure= models.TimeField(help_text="Veuillez saisir l'heure au format H : M")
    ...
    def save(self):
        ...
        heure =(str(self.heure.strftime('%d-%m-%Y')))
